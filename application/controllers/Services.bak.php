...
class Services extends CI_Controller {
        ...
        public function index() {		
			...
			$config["num_links"] = 9;
				...
				elseif ($this->input->get('search_param') != NULL) {
					...
					$data['nonvoters'] = $this->services_model->get_nv_services($config["per_page"], $page);
					$data['rvoters'] = $this->services_model->get_rv_services($config["per_page"], $page);
		...
		//essentially classifies a beneficiary as either a registered voter or a non-voter and loads the appropriate viewing pages 
                ...
                $beneficiary = $this->services_model->get_beneficiary_by_id($id);
		...
		public function add() {
			...
			$this->form_validation->set_rules('services_status','services status','required');
