					...
					<div class="form-group">
						...
						<div class="col-sm-10">	
							<select name="year_level" class="form-control">
								...
								<option value="1" <?php if (set_value('award_no') == 1) echo 'selected'; ?> >1</option>
								<option value="2" <?php if (set_value('award_no') == 1) echo 'selected'; ?> >2</option>
								<option value="3" <?php if (set_value('award_no') == 1) echo 'selected'; ?> >3</option>
								<option value="4" <?php if (set_value('award_no') == 1) echo 'selected'; ?> >4</option>
								<option value="5" <?php if (set_value('award_no') == 1) echo 'selected'; ?> >5</option>
							</select>
						</div>
					</div>
					<div class="form-group">
