<div class="container">
	...
	{
	?>
	<div class="container-fluid text-right"><a href="<?php echo base_url('rvoters/add') ?>"><span class="glyphicon glyphicon-plus-sign"></span> New entry</a></div>
	<?php
	}
	?>
	<p>&nbsp;</p>
	<div class="container-fluid text-right">
		...
		<?php echo form_close();?>
		<a href="rvoters/advanced">Advanced Search &raquo;</a>
	</div>
	...
	<div class="container-fluid">
		...
		<?php 
			if (isset($filterval)) { 
				...
				$url = 'rvoters/results_to_excel/'.$searchval;
			}
			else {
