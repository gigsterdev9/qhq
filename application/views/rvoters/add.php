	...
	<div class="panel-body">
		...
		?>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="code" required value="<?php echo set_value('code'); ?>" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="id_no">ID No.<span class="text-info">*</span></label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="id_no" value="<?php echo set_value('id_no'); ?>" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="id_no_comelec">Comelec ID No.<span class="text-info">*</span></label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="id_no_comelec" value="<?php echo set_value('id_no_comelec'); ?>" />
					</div>
				</div>
				<div class="form-group">
					<label class="control-label col-sm-2" for="precinct">Precinct</label>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="precinct" value="<?php echo set_value('precinct'); ?>" />
					</div>
				</div>
				<div class="form-group">
