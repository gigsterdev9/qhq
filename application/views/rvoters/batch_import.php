		...
		<div class="panel-body">
			...
			?>
				<div class="alert alert-danger">
					...
					<a href="<?php echo base_url('rvoters') ?>">Return to Index.</a>
				</div>
			<?php 
			}
			...
			?>
				<div class="alert alert-success">
					<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
					Process completed. <?php echo $ctr.' total records processed. '?> 
                    <?php 
                    if (!isset($notice)) {
                        echo 'No new data encountered.';
                    }
                    ?>
                    <br />
					<a href="<?php echo base_url('rvoters') ?>">Return to Index.</a>
			...
			echo form_open_multipart('rvoters/batch_import', $attributes); 
			?>
    ...
    <div class="panel panel-default">
		<div class="panel-body">
            <h3>Proper Usage Guide</h3>
                <ul>
                    <li>ONLY upload a properly structured CSV file. Refer to the <a href="<?php echo (base_url('downloads/test-data-rvoters-update.csv') ); ?>">sample CSV file</a>. 
                    ...
                    <hr />
                    <p><a href="<?php echo (base_url('downloads/test-data-rvoters-update.csv') ); ?>">Download sample CSV data here</a>.</p>
                    <p>&nbsp;</p>
                    <p><a href="<?php echo base_url('rvoters'); ?>"><?php echo base_url('rvoters'); ?></a></p>
